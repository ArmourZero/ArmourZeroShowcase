...
// Whitelist of allowed key identifiers
...
if (isset($_GET["key"]) && !empty($_GET["key"])) {
    ...
    if (in_array($key, $allowed_keys, true)) {
        $output = "Selected key identifier: " . htmlspecialchars($key, ENT_QUOTES, 'UTF-8');
        if ($key === "Key1") {
            $output .= "<br>Welldone! You selected the first key.";
        }
    } else {
        $status_code = 400;
        $output = "Invalid input. Please select a valid key identifier.";
    }
} else {
    ...
    <div class="main-container">
        <div class="main-content">
            ...
            <p class="exploit-example">
                ...
                Vulnerability is fixed; the attacker cannot access the private key.
            </p>
